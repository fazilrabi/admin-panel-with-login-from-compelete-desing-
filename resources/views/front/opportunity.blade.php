            ...
            <div class="col-sm-6">
                <div class="text-sm-left af-rtl af-tr">
                    <div class="page-next-level">
                        <h4 class="title">{{$opportunity->{'title_' . $lang} }}</h4>
                    </div>
                </div>
            </div>
            <!--end col-->
                ...
                <div class="page-next-level text-sm-right">
                    <ul class="page-next pl-0 mb-0">
                        ...
                        <li class="list-inline-item">
                            <span class="text-uppercase text-primary font-weight-bold">{{$opportunity->{'title_' . $lang} }}
                            </span>
                        </li>
                    </ul>
                </div>
...
<section class="section">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="position-relative">
                  <img src="{{asset('storage/images/opportunity/' . $opportunity->image)}}" class="img-fluid shadow rounded" alt="">
                </div>
            </div>
            <!--end col-->
            ...
            <div class="col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                <div class="section-title ml-md-4">
                    <h4 class="title mb-4">{{$opportunity->{'title_' . $lang} }}</h4>
                    {!! $opportunity->{'description_' . $lang} !!}
                </div>
            </div>
        </div>
        <!--end row-->
