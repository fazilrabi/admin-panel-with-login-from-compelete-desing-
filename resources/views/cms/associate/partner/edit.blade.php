@extends('cms.app')
@section('title', 'Edit Partner | DOMYA Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Edit Partner
                <div class="page-title-subheading">Fill the following form to edit a partner</div>
            </div>
        </div>
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.associate.partner.update', $partner)}}" enctype="multipart/form-data"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_en" id="title_en" placeholder="Canada Embassy"
                        type="text" class="form-control" value="{{$partner->title_en}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_ps" id="title_ps" placeholder="سفارت کانادا" type="text" class="form-control" value="{{$partner->title_ps}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_fa" id="title_fa" placeholder="سفارت کانادا"
                        type="text" class="form-control" value="{{$partner->title_fa}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-4">
                    <img src="{{asset('storage/images/partner/' . $partner->image)}}" alt="Partner Image" class="mw-100"
