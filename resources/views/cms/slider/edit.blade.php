    ...
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.slider.update', $slider)}}"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_ps" id="title_ps" placeholder="د ښځو په هکله بیړنی خبرونه" type="text"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="subtitle_ps" id="subtitle_ps" placeholder="د تر ټولو موثق سرچینو څخه" type="text"
