@extends('cms.app')
@section('title', 'Edit About | DMOYA Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Edit About
                <div class="page-title-subheading">Fill the following form to edit a about</div>
            </div>
        </div>
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.about.index')}}" type="button" class="btn-shadow btn btn-info"
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.about.update', $about)}}" enctype="multipart/form-data"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_en" id="title_en" placeholder="Civil Voice for Peace"
                        type="text" class="form-control" value="{{$about->title_en}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description_en" id="description_en" placeholder="Description Goes Here" type="text" class="form-control tiny" required>{{$about->description_en}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_ps" id="title_ps" placeholder="روز زن" type="text" class="form-control" value="{{$about->title_ps}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description_ps" id="description_ps" placeholder="Description Goes Here" type="text" class="form-control tiny" required>{{$about->description_ps}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_fa" id="title_fa" placeholder="روز زن"
                        type="text" class="form-control" value="{{$about->title_fa}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description_fa" id="description_fa" placeholder="Description Goes Here" type="text" class="form-control tiny" required>{{$about->description_fa}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-4">
                    <img src="{{asset('storage/images/about/' . $about->image)}}" alt="About Image" class="mw-100"
