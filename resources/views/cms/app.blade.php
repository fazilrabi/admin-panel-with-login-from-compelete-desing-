...
<head>
    ...
    <meta name="description" content="This is an example dashboard created using build-in elements & components.">
    ...
    <link href="{{asset('cms/css/main.css')}}" rel="stylesheet">
    <!-- Dropzone css -->
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                            class="p-0 btn">
                                            <img class="rounded-circle" src="{{asset('cms/assets/images/boss.png')}}"
                                                alt="" width="42">
                                            ...
                                            <div class="dropdown-menu-header" style="margin-bottom: 0;">
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    <div class="menu-header-image opacity-2"
                                                        style="background-image: url('<?php echo asset('cms/assets/images/dropdown-header/city3.jpg'); ?>');">
                                                    </div>
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img class="rounded-circle"
                                                                        src="{{asset('cms/assets/images/boss.png')}}"
                                                                        alt="" width="42">
                                                                </div>
                                                                <div class="widget-content-left">
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{route('admin.opportunity.index')}}"
                                    class="{{request()->routeIs('admin.opportunity*') ? 'mm-active' : ''}}">
                                    <i class="metismenu-icon pe-7s-home"></i> Opportunities
                                </a>
                            </li>
                            <li>
                                <a href="{{route('admin.blog.index')}}"
                                    class="{{request()->routeIs('admin.blog*') ? 'mm-active' : ''}}">
                                    <i class="metismenu-icon pe-7s-home"></i> Blog
                                </a>
                            </li>
                            <li>
                                <a href="{{route('admin.event.index')}}"
                                    class="{{request()->routeIs('admin.event*') ? 'mm-active' : ''}}">
                                    <i class="metismenu-icon pe-7s-home"></i> Events
                                </a>
                            </li>
                            <li class="{{(request()->routeIs('admin.associate*')) ? 'mm-active' : ''}}">
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-home"></i>Associates
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.associate.donor.index')}}"
                                            class="{{request()->routeIs('admin.associate.donor*') ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i> Donors
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.associate.partner.index')}}"
                                            class="{{request()->routeIs('admin.associate.partner*') ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i> Partners
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{(request()->routeIs('admin.about*')) ? 'mm-active' : ''}}">
                                <a href="#">
                                    <i class="metismenu-icon pe-7s-home"></i>About Us
                                    <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                </a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.about.index')}}"
                                            ...
                                            <i class="metismenu-icon"></i> About Pages
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.about.advisor.index')}}"
                                            class="{{request()->routeIs('admin.about.advisor*') ? 'mm-active' : ''}}">
                                            <i class="metismenu-icon"></i> Advisors
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="{{route('admin.contacts')}}"
                                    class="{{request()->routeIs('admin.contacts*') ? 'mm-active' : ''}}">
                                    <i class="metismenu-icon pe-7s-home"></i> Contacts
                                </a>
                            </li>
                        </ul>
                    </div>
