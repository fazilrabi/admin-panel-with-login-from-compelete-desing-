@extends('cms.app')
@section('title', 'Add Blog | DMOYA Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Add Blog
                <div class="page-title-subheading">Fill the following form to add a blog</div>
            </div>
        </div>
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.blog.store')}}" enctype="multipart/form-data"
