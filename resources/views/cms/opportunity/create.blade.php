@extends('cms.app')
@section('title', 'Add Opportunity | DMOYA Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Add Opportunity
                <div class="page-title-subheading">Fill the following form to add a opportunity</div>
            </div>
        </div>
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.opportunity.store')}}" enctype="multipart/form-data"
